        ...
        <div className="container register-form">
            <div className="heading-section">
                <div className="main-heading">
                    Welcome to BBTTC <span className="highlightme">LEARN</span> and <span className="highlightme">GROW</span> with everyone
                </div>
                <div className="help-text">
                    Have great time learning <br/> <span className="highlightme">an unleash your creativity</span> 
                </div>
            </div>
            <div className="row">
                        ...
                        <div className="panel panel-default p50 uth-panel">
                            <div className="panel-body uth-panel-body">
                                ...
                                <div className="col-md-12">
                                    <div className="form-wrap">
                                        <label>Age</label>
                                        <Validation.components.Input onChange={this.logChange} className="form-control" value='' placeholder='15' name='number' validations={['required', 'number']}/>
                                    </div>
                                </div>
                                 <div className="col-md-12">
                                    <div className="form-wrap">
                                ...
                                <div className="col-md-12">
                                    <div className="form-wrap">
                                        <label>City</label>
                                        <Validation.components.Input onChange={this.logChange} className="form-control" value='' placeholder='Minneapolis' name='city' validations={['required']}/>
                                    </div>
                                </div>
                                <div className="col-md-12">
                                    <div className="form-wrap">
                                ...
                                <div className="col-md-12">
                                    <div className="form-wrap">
                                        ...
                                        <Validation.components.Input onChange={this.logChange} className="form-control" value='' placeholder='Parent Name' name='guardian' validations={['required']}/>
                                    </div>
                                </div>
                                <div className="col-md-12">
                                    <div className="form-wrap">
                                        <label>Preferred Name</label>
                                        <Validation.components.Input onChange={this.logChange} className="form-control" value='' placeholder='' name='nickName' validations={['required']}/>
                                    </div>
                                </div>
                                {/*<div className="col-md-12">
                                    <div className="form-wrap">
